...
const HospitalItemCard = ({ id, name, special, location, totalbed, bed: initialBed, emtotalbed, embed, description, image, isLoggedIn, contact }) => {
  ...
  return (
    <div className="hospital-item-card border border-gray-300 shadow-lg rounded-lg p-4 flex w-full gap-6 items-center justify-between">
      ...
      <div className="hospital-details flex flex-col w-1/2 gap-2">
        ...
        <p className="hospital-contact text-gray-700 font-medium text-xs -mt-2">Contact Us: {contact}</p>
      </div>
      ...
      {showConfirmModal && (
        <div className="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-5 rounded-lg shadow-lg">
            <p>Yes if you are sure about your booking.</p>

...
import Signup from '../src/patient/components/SignUp/Signup' // Import the Signup component
import Chatbot from './patient/pages/Home/chatbot';
...
import TreatmentForm from './Doctor/components/TreatmentForm/TreatmentForm';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/treatment" element={<TreatmentForm setUserRole={setUserRole} />} />
